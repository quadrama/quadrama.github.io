...
<div class="figure" id="utterance-length-variation-vndf0">
  <div>bla</div>
  <p class="caption">Variation der Äußerungslänge bei <span class="qd_title">Romeo und Julia</span> (Ü: Schlegel)</p>
</div>
